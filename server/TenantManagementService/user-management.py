...
stack_prefix = os.environ.get('STACK_PREFIX', 'demo-saas')
table_tenant_user_map = dynamodb.Table(f'{stack_prefix}-TenantUserMapping')
table_tenant_details = dynamodb.Table(f'{stack_prefix}-TenantDetails')
